...
{
    gPlayerText[playerid][0] = CreatePlayerTextDraw(playerid, 478.600646, 178.000015, "slaughter:_10");
    ...
    gPlayerText[playerid][1] = CreatePlayerTextDraw(playerid, 528.369689, 178.000015, "death:_10");
    PlayerTextDrawLetterSize(playerid, gPlayerText[playerid][1], 0.140000, 0.944592);
    PlayerTextDrawAlignment(playerid, gPlayerText[playerid][1], 1);
    PlayerTextDrawColor(playerid, gPlayerText[playerid][1], -1);
    PlayerTextDrawSetShadow(playerid, gPlayerText[playerid][1], 0);
    ...
    gPlayerText[playerid][2] = CreatePlayerTextDraw(playerid, 478.269744, 205.544021, "slaughter:_10");
    ...
    gPlayerText[playerid][3] = CreatePlayerTextDraw(playerid, 492.670623, 223.345108, "Closes at 10 slaughter");
    ...
    gPlayerText[playerid][4] = CreatePlayerTextDraw(playerid, 478.969787, 196.143447, "Leader:_");
...
hook OnGameModeInit()
{
    ...
    gGlobalText[1] = TextDrawCreate(488.600555, 150.177780, "points");
