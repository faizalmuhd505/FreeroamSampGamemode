...
{
    gPlayerText[playerid][0] = CreatePlayerTextDraw(playerid, 320.000213, 105.377769, "title");
    ...
    gPlayerText[playerid][1] = CreatePlayerTextDraw(playerid, 58.666908, 153.170379, "text");
